...
if __name__ == '__main__':
    ...
    parser.add_argument("--K", default=200, type=int, help="maximum degree")
    parser.add_argument("--r", default=10, type=int, help="maximum hop")
    parser.add_argument("--score_upper_bound", default=10, type=int)
    parser.add_argument("--target_epsilon", default=3, type=int)
    parser.add_argument("--gamma", default=0.3242, type=float)
    ...
    parser.add_argument("--num_subgraph", default=128)
